module.exports=[629202,a=>{"use strict";let b=(0,a.i(164831).default)("wallet",[["path",{d:"M19 7V4a1 1 0 0 0-1-1H5a2 2 0 0 0 0 4h15a1 1 0 0 1 1 1v4h-3a2 2 0 0 0 0 4h3a1 1 0 0 0 1-1v-2a1 1 0 0 0-1-1",key:"18etb6"}],["path",{d:"M3 5v14a2 2 0 0 0 2 2h15a1 1 0 0 0 1-1v-4",key:"xoc0q4"}]]);a.s(["Wallet",0,b],629202)},24198,a=>{"use strict";async function b(a,b){let c=await fetch(a,b),d=await c.json().catch(()=>null);if(!c.ok)throw Error(d?.error||d?.message||`Request failed with ${c.status}`);return d}a.s(["apiJson",0,b,"errorMessage",0,function(a,b="Something went wrong"){return a instanceof Error?a.message:b}])},674746,a=>{"use strict";let b=(0,a.i(164831).default)("send",[["path",{d:"M14.536 21.686a.5.5 0 0 0 .937-.024l6.5-19a.496.496 0 0 0-.635-.635l-19 6.5a.5.5 0 0 0-.024.937l7.93 3.18a2 2 0 0 1 1.112 1.11z",key:"1ffxy3"}],["path",{d:"m21.854 2.147-10.94 10.939",key:"12cjpa"}]]);a.s(["Send",0,b],674746)},118688,a=>{"use strict";let b=(0,a.i(164831).default)("book-open",[["path",{d:"M12 7v14",key:"1akyts"}],["path",{d:"M3 18a1 1 0 0 1-1-1V4a1 1 0 0 1 1-1h5a4 4 0 0 1 4 4 4 4 0 0 1 4-4h5a1 1 0 0 1 1 1v13a1 1 0 0 1-1 1h-6a3 3 0 0 0-3 3 3 3 0 0 0-3-3z",key:"ruj8y"}]]);a.s(["BookOpen",0,b],118688)},366286,a=>{"use strict";var b=a.i(406704);a.s(["notify",0,{success:a=>b.default.success(a),error:a=>b.default.error(a),warning:a=>(0,b.default)(a,{icon:"⚠️"}),info:a=>(0,b.default)(a,{icon:"ℹ️"})}])},88444,a=>{"use strict";let b=(0,a.i(164831).default)("printer",[["path",{d:"M6 18H4a2 2 0 0 1-2-2v-5a2 2 0 0 1 2-2h16a2 2 0 0 1 2 2v5a2 2 0 0 1-2 2h-2",key:"143wyd"}],["path",{d:"M6 9V3a1 1 0 0 1 1-1h10a1 1 0 0 1 1 1v6",key:"1itne7"}],["rect",{x:"6",y:"14",width:"12",height:"8",rx:"1",key:"1ue0tg"}]]);a.s(["Printer",0,b],88444)},391393,a=>{"use strict";var b=a.i(366286);async function c({title:a,subtitle:g,documentLabel:h,metaHtml:i,bodyHtml:j,footerHtml:k,popupError:l="Allow popups to print this document.",pageSize:m="full",verificationUrl:n,barcodeValue:o}){var p;let q=window.open("","_blank","half"===m?"width=760,height=620":"width=980,height=760");if(!q)return void b.notify.error(l);q.document.open(),q.document.write((p=a,`
  ...
  `}({branding:r,title:a,subtitle:g,documentLabel:h,metaHtml:i,bodyHtml:j,footerHtml:k,pageSize:m,verificationUrl:n,barcodeValue:o,qrDataUrl:s})),q.document.close(),q.focus(),window.setTimeout(()=>{q.print()},250)}function d(a){return a.replaceAll("&","&amp;").replaceAll("<","&lt;").replaceAll(">","&gt;").replaceAll('"',"&quot;").replaceAll("'","&#039;")}async function e(){try{let a=await fetch("/api/my-school-branding",{cache:"no-store"});if(!a.ok)throw Error("Branding unavailable");return await a.json()}catch{return{schoolName:"TOTTECH ONE",schoolCode:"Gateway To Learning",logoUrl:"/images/logo.png",primaryColor:"#04142E",secondaryColor:"#D4AF37"}}}async function f(b){try{return(await a.A(653920)).toDataURL(b,{errorCorrectionLevel:"M",margin:1,width:120,color:{dark:"#111111",light:"#FFFFFF"}})}catch{return null}}a.s(["printBrandedDocument",0,c,"printMetaGrid",0,function(a){return`<div class="print-meta-grid">${a.map(a=>`
      ...
      `).join("")}</div>`}])},280337,a=>{"use strict";var b=a.i(187924),c=a.i(88444),d=a.i(572131),e=a.i(27508),f=a.i(24198),g=a.i(391393),h=a.i(366286);async function i(a){let b=a.receipt_number||`Receipt ${a.id}`;await (0,g.printBrandedDocument)({title:"Fee Payment Receipt",subtitle:"Official payment acknowledgement generated from TOTTECH ONE.",documentLabel:"Paid Receipt",pageSize:"half",metaHtml:(0,g.printMetaGrid)([{label:"Receipt",value:b},{label:"Invoice",value:a.invoice_number||"-"},{label:"Student",value:a.student_name||"-"},{label:"Class / Section",value:[a.class_name,a.section_name].filter(Boolean).join(" ")||"-"},{label:"Amount Paid",value:`Rs. ${Number(a.amount||0)}`},{label:"Payment Method",value:a.payment_method||"-"},{label:"Reference",value:a.reference_number||"-"},{label:"Date",value:j(a.payment_date||a.created_at)}]),bodyHtml:`
      <div class="print-panel">
	    ...
	    `,verificationUrl:"",barcodeValue:String(b),popupError:"Allow popups to print this receipt."})}function j(a){return a?new Date(a).toLocaleDateString():"-"}a.s(["default",0,function(){let[a,g]=(0,d.useState)([]),[k,l]=(0,d.useState)(!0);return(0,d.useEffect)(()=>{(async()=>{try{let a=await (0,f.apiJson)("/api/finance/payments");g(a.payments||[])}catch(a){h.notify.error((0,f.errorMessage)(a,"Failed to load receipts"))}finally{l(!1)}})()},[]),(0,b.jsx)(e.default,{children:(0,b.jsxs)("div",{className:"space-y-6",children:[(0,b.jsxs)("div",{children:[(0,b.jsx)("h1",{className:"text-3xl font-black md:text-4xl",children:"Paid Receipts"}),(0,b.jsx)("p",{className:"mt-1 text-sm text-slate-600",children:"Print payment receipts from real fee collection records."})]}),(0,b.jsx)("section",{className:"tt-card tt-card-pad",children:k?(0,b.jsx)("p",{className:"text-sm font-semibold text-slate-600",children:"Loading receipts..."}):0===a.length?(0,b.jsx)("p",{className:"text-sm font-semibold text-slate-600",children:"No paid receipts found for the selected school and academic year."}):(0,b.jsx)("div",{className:"overflow-x-auto",children:(0,b.jsxs)("table",{className:"min-w-full text-left text-sm",children:[(0,b.jsx)("thead",{children:(0,b.jsxs)("tr",{className:"border-b border-slate-200 text-xs uppercase text-slate-500",children:[(0,b.jsx)("th",{className:"py-3 pr-4",children:"Receipt"}),(0,b.jsx)("th",{className:"py-3 pr-4",children:"Invoice"}),(0,b.jsx)("th",{className:"py-3 pr-4",children:"Student"}),(0,b.jsx)("th",{className:"py-3 pr-4",children:"Amount"}),(0,b.jsx)("th",{className:"py-3 pr-4",children:"Method"}),(0,b.jsx)("th",{className:"py-3 pr-4",children:"Date"}),(0,b.jsx)("th",{className:"py-3 pr-4",children:"Action"})]})}),(0,b.jsx)("tbody",{children:a.map(a=>(0,b.jsxs)("tr",{className:"border-b border-slate-100",children:[(0,b.jsx)("td",{className:"py-3 pr-4 font-black text-slate-950",children:a.receipt_number||`Receipt ${a.id}`}),(0,b.jsx)("td",{className:"py-3 pr-4",children:a.invoice_number||"-"}),(0,b.jsxs)("td",{className:"py-3 pr-4",children:[(0,b.jsx)("div",{className:"font-bold text-slate-950",children:a.student_name||"-"}),(0,b.jsx)("div",{className:"text-xs text-slate-500",children:[a.class_name,a.section_name].filter(Boolean).join(" ")||"-"})]}),(0,b.jsxs)("td",{className:"py-3 pr-4 font-black",children:["Rs."," ",Number(a.amount||0)]}),(0,b.jsx)("td",{className:"py-3 pr-4",children:a.payment_method||"-"}),(0,b.jsx)("td",{className:"py-3 pr-4",children:j(a.payment_date||a.created_at)}),(0,b.jsx)("td",{className:"py-3 pr-4",children:(0,b.jsxs)("button",{onClick:()=>i(a),className:"inline-flex items-center gap-2 rounded-lg border border-amber-200 bg-amber-50 px-3 py-2 text-sm font-black text-amber-900",children:[(0,b.jsx)(c.Printer,{size:15}),"Print"]})})]},a.id))})]})})})]})})}])},653920,a=>{a.v(b=>Promise.all(["server/chunks/ssr/[externals]_qrcode_0h7j8o7._.js"].map(b=>a.l(b))).then(()=>b(941287)))}];

//# sourceMappingURL=%5Broot-of-the-server%5D__0yof.xh._.js.map