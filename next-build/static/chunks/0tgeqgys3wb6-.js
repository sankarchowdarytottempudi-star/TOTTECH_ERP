...
to {
  ...
  animation: ${V} 0.3s 0.12s cubic-bezier(0.175, 0.885, 0.32, 1.275)
    forwards;
`,W=({toast:e})=>{let{icon:t,type:r,iconTheme:a}=e;return void 0!==t?"string"==typeof t?s.createElement(K,null,t):t:"blank"===r?null:s.createElement(F,null,s.createElement(z,{...a}),"loading"!==r&&s.createElement(H,null,"error"===r?s.createElement(D,{...a}):s.createElement(B,{...a})))},q=g("div")`
  display: flex;
  align-items: center;
  background: #fff;
  color: #363636;
...
`];return{animation:t?`${y(a)} 0.35s cubic-bezier(.21,1.02,.73,1) forwards`:`${y(s)} 0.4s forwards cubic-bezier(.06,.71,.55,1)`}})(e.position||t||"top-center",e.visible):{opacity:0},o=s.createElement(W,{toast:e}),n=s.createElement(J,{...e.ariaProps},b(e.message,e));return s.createElement(q,{className:e.className,style:{...i,...r,...e.style}},"function"==typeof a?a({icon:o,message:n}):s.createElement(s.Fragment,null,o,n))});a=s.createElement,c.p=void 0,f=a,h=void 0,m=void 0;var Z=({id:e,className:t,style:r,onHeightUpdate:a,children:i})=>{let o=s.useCallback(t=>{if(t){let r=()=>{a(e,t.getBoundingClientRect().height)};r(),new MutationObserver(r).observe(t,{subtree:!0,childList:!0,characterData:!0})}},[e,a]);return s.createElement("div",{ref:o,className:t,style:r},i)},G=p`
  z-index: 9999;
  > * {
    pointer-events: auto;
  }
`;e.s(["Toaster",0,({reverseOrder:e,position:t="top-center",toastOptions:r,gutter:a,children:i,toasterId:o,containerStyle:n,containerClassName:l})=>{let{toasts:c,handlers:d}=((e,t="default")=>{let{toasts:r,pausedAt:a}=((e={},t=k)=>{let[r,a]=(0,s.useState)(M[t]||C),i=(0,s.useRef)(M[t]);(0,s.useEffect)(()=>(i.current!==M[t]&&a(M[t]),w.push([t,a]),()=>{let e=w.findIndex(([e])=>e===t);e>-1&&w.splice(e,1)}),[t]);let o=r.toasts.map(t=>{var r,a,s;return{...e,...e[t.type],...t,removeDelay:t.removeDelay||(null==(r=e[t.type])?void 0:r.removeDelay)||(null==e?void 0:e.removeDelay),duration:t.duration||(null==(a=e[t.type])?void 0:a.duration)||(null==e?void 0:e.duration)||_[t.type],style:{...e.style,...null==(s=e[t.type])?void 0:s.style,...t.style}}});return{...r,toasts:o}})(e,t),i=(0,s.useRef)(new Map).current,o=(0,s.useCallback)((e,t=P)=>{if(i.has(e))return;let r=setTimeout(()=>{i.delete(e),n({type:4,toastId:e})},t);i.set(e,r)},[]);(0,s.useEffect)(()=>{if(a)return;let e=Date.now(),s=r.map(r=>{if(r.duration===1/0)return;let a=(r.duration||0)+r.pauseDuration-(e-r.createdAt);if(a<0){r.visible&&A.dismiss(r.id);return}return setTimeout(()=>A.dismiss(r.id,t),a)});return()=>{s.forEach(e=>e&&clearTimeout(e))}},[r,a,t]);let n=(0,s.useCallback)(E(t),[t]),l=(0,s.useCallback)(()=>{n({type:5,time:Date.now()})},[n]),c=(0,s.useCallback)((e,t)=>{n({type:1,toast:{id:e,height:t}})},[n]),d=(0,s.useCallback)(()=>{a&&n({type:6,time:Date.now()})},[a,n]),u=(0,s.useCallback)((e,t)=>{let{reverseOrder:a=!1,gutter:s=8,defaultPosition:i}=t||{},o=r.filter(t=>(t.position||i)===(e.position||i)&&t.height),n=o.findIndex(t=>t.id===e.id),l=o.filter((e,t)=>t<n&&e.visible).length;return o.filter(e=>e.visible).slice(...a?[l+1]:[0,l]).reduce((e,t)=>e+(t.height||0)+s,0)},[r]);return(0,s.useEffect)(()=>{r.forEach(e=>{if(e.dismissed)o(e.id,e.removeDelay);else{let t=i.get(e.id);t&&(clearTimeout(t),i.delete(e.id))}})},[r,o]),{toasts:r,handlers:{updateHeight:c,startPause:l,endPause:d,calculateOffset:u}}})(r,o);return s.createElement("div",{"data-rht-toaster":o||"",style:{position:"fixed",zIndex:9999,top:16,left:16,right:16,bottom:16,pointerEvents:"none",...n},className:l,onMouseEnter:d.startPause,onMouseLeave:d.endPause},c.map(r=>{let o,n,l=r.position||t,c=d.calculateOffset(r,{reverseOrder:e,gutter:a,defaultPosition:t}),u=(o=l.includes("top"),n=l.includes("center")?{justifyContent:"center"}:l.includes("right")?{justifyContent:"flex-end"}:{},{left:0,right:0,display:"flex",position:"absolute",transition:x()?void 0:"all 230ms cubic-bezier(.21,1.02,.73,1)",transform:`translateY(${c*(o?1:-1)}px)`,...o?{top:0}:{bottom:0},...n});return s.createElement(Z,{id:r.id,key:r.id,onHeightUpdate:d.updateHeight,className:r.visible?G:"",style:u},"custom"===r.type?b(r.message,r):i?i(r):s.createElement(X,{toast:r,position:l}))}))},"default",0,A,"toast",0,A],705766)},920476,e=>{"use strict";async function t(e,t){let r=await fetch(e,t),a=await r.json().catch(()=>null);if(!r.ok)throw Error(a?.error||a?.message||`Request failed with ${r.status}`);return a}e.s(["apiJson",0,t,"errorMessage",0,function(e,t="Something went wrong"){return e instanceof Error?e.message:t}])},730274,e=>{"use strict";let t=(0,e.i(456420).default)("send",[["path",{d:"M14.536 21.686a.5.5 0 0 0 .937-.024l6.5-19a.496.496 0 0 0-.635-.635l-19 6.5a.5.5 0 0 0-.024.937l7.93 3.18a2 2 0 0 1 1.112 1.11z",key:"1ffxy3"}],["path",{d:"m21.854 2.147-10.94 10.939",key:"12cjpa"}]]);e.s(["Send",0,t],730274)},856423,e=>{"use strict";let t=(0,e.i(456420).default)("book-open",[["path",{d:"M12 7v14",key:"1akyts"}],["path",{d:"M3 18a1 1 0 0 1-1-1V4a1 1 0 0 1 1-1h5a4 4 0 0 1 4 4 4 4 0 0 1 4-4h5a1 1 0 0 1 1 1v13a1 1 0 0 1-1 1h-6a3 3 0 0 0-3 3 3 3 0 0 0-3-3z",key:"ruj8y"}]]);e.s(["BookOpen",0,t],856423)},141603,e=>{"use strict";var t=e.i(843476),r=e.i(705766),a=e.i(271645),s=e.i(859015);e.s(["default",0,function(){let[e,i]=(0,a.useState)([]),[o,n]=(0,a.useState)([]),[l,c]=(0,a.useState)(""),[d,u]=(0,a.useState)("Present");(0,a.useEffect)(()=>{p()},[]);let p=async()=>{try{let e=await fetch("/api/teachers"),t=await fetch("/api/staff-attendance"),r=await e.json(),a=await t.json();i(Array.isArray(r)?r:[]),n(Array.isArray(a)?a:[])}catch(e){console.error(e)}},f=async()=>{if(!l)return void r.default.success("Please select a teacher");try{await fetch("/api/staff-attendance",{method:"POST",headers:{"Content-Type":"application/json"},body:JSON.stringify({teacher_id:Number(l),status:d,remarks:""})}),c(""),u("Present"),p(),r.default.success("Staff Attendance Saved")}catch(e){console.error(e),r.default.success("Failed to Save Attendance")}};return(0,t.jsx)(s.default,{children:(0,t.jsxs)("div",{className:"space-y-10",children:[(0,t.jsxs)("div",{className:"bg-white rounded-3xl p-10 shadow",children:[(0,t.jsx)("h1",{className:"text-4xl font-bold mb-8",children:"Staff Attendance"}),(0,t.jsxs)("div",{className:"grid grid-cols-1 md:grid-cols-2 gap-5",children:[(0,t.jsxs)("select",{className:"border p-4 rounded-xl",value:l,onChange:e=>c(e.target.value),children:[(0,t.jsx)("option",{value:"",children:"Select Teacher"}),e.map(e=>(0,t.jsxs)("option",{value:e.id,children:[e.first_name," ",e.last_name]},e.id))]}),(0,t.jsxs)("select",{className:"border p-4 rounded-xl",value:d,onChange:e=>u(e.target.value),children:[(0,t.jsx)("option",{value:"Present",children:"Present"}),(0,t.jsx)("option",{value:"Absent",children:"Absent"}),(0,t.jsx)("option",{value:"Late",children:"Late"}),(0,t.jsx)("option",{value:"Half Day",children:"Half Day"}),(0,t.jsx)("option",{value:"On Leave",children:"On Leave"})]})]}),(0,t.jsx)("button",{onClick:f,className:"mt-6 px-6 py-3 bg-green-600 text-white rounded-xl font-semibold",children:"Save Attendance"})]}),(0,t.jsxs)("div",{className:"bg-white rounded-3xl p-10 shadow",children:[(0,t.jsx)("h2",{className:"text-3xl font-bold mb-6",children:"Staff Attendance Records"}),(0,t.jsxs)("table",{className:"w-full",children:[(0,t.jsx)("thead",{children:(0,t.jsxs)("tr",{className:"border-b",children:[(0,t.jsx)("th",{className:"text-left py-3",children:"ID"}),(0,t.jsx)("th",{className:"text-left py-3",children:"Teacher Name"}),(0,t.jsx)("th",{className:"text-left py-3",children:"Status"}),(0,t.jsx)("th",{className:"text-left py-3",children:"Date"})]})}),(0,t.jsx)("tbody",{children:0===o.length?(0,t.jsx)("tr",{children:(0,t.jsx)("td",{colSpan:4,className:"text-center py-10 text-slate-500",children:"No Attendance Records"})}):o.map(r=>{var a;let s;return(0,t.jsxs)("tr",{className:"border-b",children:[(0,t.jsx)("td",{className:"py-3",children:r.id}),(0,t.jsx)("td",{className:"py-3",children:(a=r.teacher_id,(s=e.find(e=>e.id===a))?`${s.first_name||""} ${s.last_name||""}`:"Unknown Teacher")}),(0,t.jsx)("td",{className:"py-3",children:r.status}),(0,t.jsx)("td",{className:"py-3",children:r.attendance_date?new Date(r.attendance_date).toLocaleDateString():"-"})]},r.id)})})]})]})]})})}])}]);